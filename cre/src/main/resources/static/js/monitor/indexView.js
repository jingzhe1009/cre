    ...
    getProSelector: function() {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.tab12 select[name=proName]').append(htmlStr_selector);
                $('.tab3 select[name=proName]').append(htmlStr_selector);
            },
            // complete: function () {
            //     // 绑定事件
    ...
    getChannelSelector:function() {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.tab12 select[name=channelName]').append(htmlStr_selector);
                $('.tab3 select[name=channelName]').append(htmlStr_selector);
            },
            // complete: function () {
            //     // 绑定事件
        ...
        $.ajax( {
            ...
            success: function ( data ) {
                ...
                if(tabId=='3'){
                    ...
                    html +='<button class="back">返回</button>';
                    $("#desc").html(html);
                    $(".tab-content").hide();
                    ...
                    if($("#exportButton").val()=="数据导出"){
                        ...
                        html +="</tr></tbody></table>";
                        html += "<button class='download'>下载</button>"
                        $("#desc").html(html);
