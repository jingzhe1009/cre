...
public class RuleLogDay {
    ...
    public RuleLogDay(String logDayId, String consumerId, String projectNo, String modelFid, String modelRid, String methodType, String modelType, int modelSuccessCount, int modelFailCount, int modelAverageScore, int successCodeCount, int hbaseCodeCount, int systemCodeCount, int oracleCodeCount, int redInterCodeCount, int averageUseTime, String signTime) {
        this.logDayId = logDayId;
        this.consumerId = consumerId;
        this.projectNo = projectNo;
        this.modelFid = modelFid;
