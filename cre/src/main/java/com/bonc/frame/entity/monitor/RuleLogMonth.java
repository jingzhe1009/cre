...
public class RuleLogMonth {
    // 月统计日志唯一标识
    private String logMonthId;
    // 渠道唯一标识
    ...
    public String getLogMonthId() {
        return logMonthId;
    }

    public void setLogMonthId(String logMonthId) {
        this.logMonthId = logMonthId;
    }
    ...
    public RuleLogMonth(String logMonthId, String consumerId, String projectNo, String modelFid, String modelRid, String methodType, String modelType, int modelSuccessCount, int modelFailCount, int modelAverageScore, int successCodeCount, int hbaseCodeCount, int systemCodeCount, int oracleCodeCount, int redInterCodeCount, int averageUseTime, String signTime) {
