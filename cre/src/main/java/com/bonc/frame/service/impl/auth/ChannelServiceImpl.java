...
public class ChannelServiceImpl implements ChannelService {
    ...
    private final String _CHANNELPATH_PREFIX = "com.bonc.frame.mapper.oracle.auth.ChannelPathMapper.";
    private final String _CHANNEL_PREFIX="con.bonc.frame.mapper.oracle.auth.ChannelMapper.";
    ...
    public Map<String, Object> list(String channelName, String start, String size) {
        ...
        //根据渠道名称查找相关信息
        Map<String,Object> result=daoHelper.queryForPageList(_CHANNEL_PREFIX+"listByChannelName",param,start,size);
        return result;
    }
    //删除渠道
    @Override
    ...
    public ResponseResult delete(String channelId) {
        ...
        // 验证此渠道下有无用户
        List<UserChannel> list = daoHelper.queryForList(_CHANNEL_PREFIX + "getUserByChannel", channelId);
        if (list.size()>0){
