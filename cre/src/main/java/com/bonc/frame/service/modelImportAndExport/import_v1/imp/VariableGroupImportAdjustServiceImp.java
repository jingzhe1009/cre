 ...
 */
@Service
public class VariableGroupImportAdjustServiceImp extends AbstractImportAdjustServiceImp {
    @Override
    public ModelImportType getSupport() {
        return ModelImportType.VARIABLE_GROUP;
    }
    ...
    public String adjustKey(String type, ImportAdjustObject importAdjustObject, String toFolderId, ImportParam importParam, ImportContext context) throws Exception {
        ...
        String success = null;
        do {
            success = checkAdjustObjectProperty(type, ExportConstant.VARIABLE_GROUP_NAME, true, true, importAdjustObject, suffix, toFolderId, importParam, context);
    ...
    public String adjustOtherProperty(String type, ImportAdjustObject importAdjustObject, String toFolderId, ImportParam importParam, ImportContext context) throws Exception {
        ...
        String success = null;
        do {
            success = checkAdjustObjectProperty(type, ExportConstant.VARIABLE_GROUP_ID, false, false, importAdjustObject, suffix, toFolderId, importParam, context);
            suffix = getNextSuffix(suffix);
        } while (success == null || "-1".equals(success));
    ...
    public List<Object> updatePropertyAndgetDbObjectList(String type, ImportIdOrNameCacheObject importIdOrNameObject, ImportAdjustObject importAdjustObject, String toFolderId, ImportParam importParam, ImportContext context) throws Exception {
        ...
        VariableGroup dbvariableGroup = null;
        if (ExportConstant.VARIABLE_GROUP_NAME.equals(idOrNameType)) {
            if (!StringUtils.isBlank(idOrNameValue)) {
                ...
                dbvariableGroup = variableService.getVariableGroupById(null, idOrNameValue);
            }
        } else if (ExportConstant.VARIABLE_GROUP_ID.equals(idOrNameType)) {
            if (!StringUtils.isBlank(idOrNameValue)) {
                ...
                dbvariableGroup = variableService.getVariableGroupById(idOrNameValue, null);
            }
        } else {
    ...
    public void dataPersistenceObject(String type, Object o, ImportContext context) throws Exception {
        if ((getSupport().getValue()).equals(type)) {
            VariableGroup variable = (VariableGroup) o;
            variableService.insertVariableGroupDataPersistence(variable);
        }
    }
}
