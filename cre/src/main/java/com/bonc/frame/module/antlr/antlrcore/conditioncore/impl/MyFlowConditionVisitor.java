 ...
 */
public class MyFlowConditionVisitor extends ConditionBaseVisitor<String> {
    private Map<String, String> funCallMap;

    public MyFlowConditionVisitor() {
        super();
        funCallMap = new HashMap<String, String>();
    }

    public MyFlowConditionVisitor(Map<String, String> funCallMap) {
        this.funCallMap = funCallMap;
    }


    @Override
    public String visitExpr(ConditionParser.ExprContext ctx) {
