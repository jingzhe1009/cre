...
import com.bonc.frame.module.db.meta.core.scan.XCloudTableScanProvider;
...
public class XCloudTableService extends AbstractScanService<TableInfo> {

    private static final Log Log = LogFactory.getLog(XCloudTableService.class);
    ...
    public XCloudTableService(ScanTask scanTask, DatabaseResource databaseResource, TableMetaInfoBO tableMetaInfoBO)
            throws SQLException {
        super(scanTask);
        this.conn = new ConnectionProvider(databaseResource);
        this.scan = new XCloudTableScanProvider(this.conn, scanTask);
