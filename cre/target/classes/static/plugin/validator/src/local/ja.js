...
exports.lang = {
    ...
    range_rg: "{1}～{2}の数を入力してください",
    range_gte: "{1}以上の数を入力してください",
    range_lte: "{1}以下の数を入力してください",
    range_gtlt: "{1}～{2}の間の数を入力してください",
    range_gt: "{1}より大きい数を入力してください",
    range_lt: "{1}より小きい数を入力してください",
