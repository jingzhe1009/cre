...
/**
 * 此类会扫描指定路径下所有标注了指定的注解的类，
 * 通过getClassSet方法可获取所有符合条件的class的集合
 *
 * @author qxl
 * @version 1.0.0
 * @date 2016年11月23日 下午3:00:23
 */
public class LoadFlowNodeClasses {
     ...
     */
    public LoadFlowNodeClasses(String[] packagesToScan, Class<? extends Annotation>... annotationFilter) {
